                                    ...
                                    <div class="panel">
                                        ...
                                        <form class="form-horizontal form-variance" enctype="multipart/form-data" method="post" >
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                    <input class="form-control tags" id="tags_1" placeholder="" type="text" value="tableau,vidéo projecteur,climatisation, sonorisation,microphone" name="eq">
                                                    </div>
                                                </div>
...
// if everything is ok, try to upload file
    ...
    $id=$ii['id_local'];
    $l = mysql_query("INSERT INTO `affectation_typel` (`id_local`, `id_type`) VALUES ('$id', 2) ") or die (mysql_error());
    ...
    if(isset($q) && isset($i) && isset($l)){
        echo '<div class="alert alert-success">Salle ajouter avec succès</div>';
    }else{
